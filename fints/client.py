...
class FinTS3Client:
    ...
    @staticmethod
    def _response_handler_get_transactions_xml(responses, include_pending: bool = True, parse_into_model: bool = False):
        booked_streams = []
        pending_streams = []
    ...
    def _get_transactions_xml(self, dialog, hkcaz, account, start_date, end_date, supported_camt_messages=None,
                              include_pending: bool = True, parse_into_model: bool = True):
    ...
    def get_transactions_xml(self, account: SEPAAccount, start_date: datetime.date = None,
                             end_date: datetime.date = None, supported_camt_messages = None,
                             include_pending: bool = True, parse_into_model: bool = False) -> list:
        """
